...
export const ABOUT_COMPANY = {
  ...
  lead:
    "Sarte Global is het bureau achter webshop-latenmaken.nl. We bouwen professionele, moderne en responsive webshops voor ondernemers en bedrijven in Nederland, met een focus op sterke SEO, snelle oplevering en meetbare resultaten.",
  paragraphs: [

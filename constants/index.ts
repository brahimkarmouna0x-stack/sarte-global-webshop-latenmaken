...
export const SITE = {
  title: "Webshop laten maken | Professionele Webshops - Sarte Global",
  description:
    "Webshop laten maken bij Sarte Global: een professionele, moderne en responsive webshop voor ondernemers en bedrijven in Nederland. Sterke SEO, snelle oplevering en focus op conversie.",
  themeColor: "#0D0D0D",
  brandName: "SARTE GLOBAL",
  brandAccent: ".",
  url: "https://webshop-latenmaken.nl",
  name: "Sarte Global",
...
export const NAV_ITEMS: readonly NavItem[] = [
  { kind: "link", label: "Webshop laten maken", href: "/", shortLabel: "Webshop laten maken" },
  ...
  { kind: "link", label: "WooCommerce laten maken", href: "/woocommerce-webshop-laten-maken", shortLabel: "WooCommerce laten maken" },
  { kind: "link", label: "Shopify laten maken", href: "/shopify-webshop-laten-maken", shortLabel: "Shopify laten maken" },
...
export const HERO = {
  ...
  title: [
    {
      words: [
        { text: "Professionele Webshop Laten Maken", italicAccent: true },
      ],
    },
  ],
  subtitle:
    "Professionele, moderne en responsive webshops voor bedrijven en ondernemers in Nederland. Sterke SEO, snelle oplevering en focus op conversie en groei.",
  primaryCta: { label: "Webshop laten maken", href: "#cta" },
  ...
  scrollLabel: "Scroll",
  badgeText:
    "WEBSHOP LATEN MAKEN · SARTE GLOBAL · WEBSHOP LATEN MAKEN · SARTE GLOBAL · ",
...
export const FOOTER_MISSION =
  "Professionele, moderne webshops voor ondernemers en bedrijven in Nederland. Een dienst van Sarte Global — gebouwd voor groei en gemaakt om te verkopen." as const;

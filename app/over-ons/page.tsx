...
const PATH = "/over-ons";
const PAGE_TITLE = "Over ons — professionele webshops voor ondernemers";
const PAGE_DESC =
  "Sarte Global is het bureau achter webshop-latenmaken.nl. We bouwen professionele en moderne webshops voor ondernemers en bedrijven in Nederland.";

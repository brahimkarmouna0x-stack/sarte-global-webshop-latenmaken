...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "moderne webshop",
    "responsive webshop",
    "SEO webshop Nederland",
    "maatwerk webshop",
    "converterende webshop",
    "webshop redesign",
    "Sarte Global",
  ],
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 800,
        alt: "Sarte Global — Webshop laten maken",
      },
    ],
  },
  twitter: {
...
function buildOrganizationJsonLd(settings: SiteSettings) {
  ...
  return {
    ...
    name: SITE_NAME,
    alternateName: ["Sarte Global", "Webshop laten maken"],
    legalName: SITE_NAME,
    url: SITE_URL,
...
const SERVICE_JSON_LD = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": `${SITE_URL}/#service-webshop-laten-maken`,
  name: SERVICE_NAME,
  serviceType: "Webshop laten maken",
  provider: { "@id": `${SITE_URL}/#organization` },
  areaServed: areaServedNL(),
  description:
    "Webshop laten maken voor ondernemers en bedrijven in Nederland. Professionele, moderne en responsive webshops met sterke SEO, snelle oplevering en focus op conversie.",
};
...
const WEBSITE_JSON_LD = {
  ...
  "@id": `${SITE_URL}/#website`,
  name: SITE_NAME,
  alternateName: "Webshop laten maken",
  url: SITE_URL,
